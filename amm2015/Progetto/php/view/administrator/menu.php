<ul>
    ...
    <li class="<?= strpos($vd->getSottoPagina(),'anagrafica') !== false ? 'current_page_item' : '' ?>"><a href="administrator/anagrafica<?= $vd->scriviToken('?')?>">Anagrafica</a></li>
    <li class="<?= strpos($vd->getSottoPagina(), 'appelli') !== false ? 'current_page_item' : '' ?>"><a href="administrator/appelli<?= $vd->scriviToken('?')?>">Appelli</a></li>
